...
引数なしで `wip` を実行すると**インタラクティブモード**が起動します。連続してメモを取りたい時に便利です。
...
<p align="center" style="margin: 20px 0;">
    <img src="assets/interactive-mode.gif" alt="インタラクティブモードのデモ" width="800">
    <br>
    <em>インタラクティブモード</em>
</p>

入力してEnterを押すと即座に記録されます。
- `:help` でコマンド一覧を表示できます。
- 空行でEnterを押すか、`Ctrl+C` で終了します。
